...
const FooterNavigation = ({ customClass }) => {
    return (
        <nav className={`footer__navigation ${customClass}`}>
...
const SocialMedia = ({ customClass }) => {
    return (
        <div className={`social-media ${customClass}`}>
            <Link to="/" className="icon icon--facebook">
            ...
            <Link to="/" className="icon icon--youtube">
            ...
            <Link to="/" className="icon icon--twitter">
            ...
            <Link to="/" className="icon icon--pinterest">
            ...
            <Link to="/" className="icon icon--instagram">
